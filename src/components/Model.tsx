...
const Model: React.FC<ModelProps> = ({ position, correction}) => {
    ...
    const { nodes, materials } = useGLTF('/scene.gltf') as { nodes: any; materials: any };
    ...
    >
            <group position={[-0.526, -11.646, 0]}>
                <group rotation={[0, 0, 0]}>
                    <mesh 
                        ref={meshRef}
                        geometry={(nodes.eye_eye_material_0 as THREE.Mesh).geometry}
                    ...
                    <mesh
                        geometry={(nodes.sclera_sclera_material_0 as THREE.Mesh).geometry}
